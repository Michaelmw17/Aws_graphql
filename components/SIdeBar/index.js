...
return (
    <div>
      ...
      <h1 className="text-1xl font-semibold  mt-16 mb-16 text-center">Article Archives</h1>
                  ...
                  <Link href={`/posts/${post.id}`}>
                      <div className="flex items-center">
                        ...
                        <div className="ml-4">
                          ...
                          <div className="text-sm font-semibold text-center pt-6">Title: {post.title}</div>
                          <div className="text-sm font-semibold text-center pt-6">Author: {post.username}</div>
                          <Link href={`/posts/${post.id}`}><a className="text-sm mr-4 text-blue-500 text-center">View Post</a></Link>
                          <br/>
                          <div className="text-sm text-gray-500 invisible mt-2 mb-0">{post.date}</div>
                          </div>
                        </div>
                      </div>
                  </Link>
