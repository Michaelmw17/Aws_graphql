    ...
    <div>
        ...
        slice.map((post, index) => (
            ...
            <h2 className="text-xl font-semibold  mt-2">Title: {post.title}</h2>
                <p className="text-xl font-semibold  mt-2">Category: {post.category.label}</p>
                <p className="text-1xl mt-4 font-semibold tracking-wide">Selected Blog Category:  {post.select }</p>
